...
export function Company() {
  ...
  return (
    <div className="relative overflow-hidden bg-slate-50 pt-4 pb-4">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:flex lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
          ...
          <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-3xl">Learn Our Company</h2>
