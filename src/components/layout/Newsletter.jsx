...
//     return (
//         <div className="mt-16 border-t border-gray-900/10 pt-8 pb-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
//             <div>
//                 <h3 className="text-sm font-semibold leading-6 text-gray-900">Subscribe to our newsletter</h3>
//                 <p className="mt-2 text-sm leading-6 text-gray-600">
//                     The latest industry news, tech articles, and company resources, sent to your inbox monthly.
//                 </p>
//             </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Subscribe to JSB's newsletter.</h2>
            <p className="mt-4 text-lg leading-8 text-gray-300">
                The latest industry news, tech articles, and company resources, sent to your inbox.
            </p>
