...
//             Copyright &copy; {new Date().getFullYear()} JSB. All rights
//             reserved.
//           </p>
//         </div>
//       </Container>
...
export function Footer() {
  return (
    <footer className="bg-slate-50" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-0 pt-8 sm:pt-14 lg:px-8 lg:pt-22">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600">
              Enhancing global sustainability through innovative water-reducing solutions.
            </p>
        ...
        <div className="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
            &copy; 2023 JSB, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
